...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 17 22:33:34 2026
...
class StockDashboard:
    ...
    def create_candlestick_chart(self, df):
        """Erstellt einen Candlestick-Chart mit Indikatoren"""
        ...
        fig.update_layout(
            title=dict(
                text=f"{self.symbol_select.value} - OHLC Chart mit Indikatoren",
                font=dict(size=20)
            ),
